...
int main(void)
{
	...
	uint16_t readData = 0;
	uint16_t writeData = 0x1234;  // Example data to write
	uint16_t address = 0x03;     // Example register address (check DRV8301 datasheet for valid addresses)
	...
	while (1)
	{
		...
		DRV8301_Write(&DRV, address,  writeData);

		/* Read data from DRV8301 */
		readData = DRV8301_Read(&DRV,address);
